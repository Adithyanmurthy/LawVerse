...
export const LightningIcon = ({ size = 24 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const LockIcon = ({ size = 24 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const AlertIcon = ({ size = 24 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const BulbIcon = ({ size = 24 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M15.09 14C16.1 13.49 16.94 12.67 17.5 11.66C18.06 10.65 18.33 9.49 18.28 8.32C18.23 7.15 17.86 6.01 17.21 5.04C16.56 4.07 15.66 3.31 14.62 2.84C13.58 2.37 12.44 2.21 11.32 2.37C10.2 2.53 9.14 3 8.26 3.73C7.38 4.46 6.71 5.42 6.33 6.51C5.95 7.6 5.87 8.78 6.09 9.91" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M9 14H15V18H9V14Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
