  ...
  const features = [
    {
      id: "search",
      title: "Search",
      headline: "Semantic Search Across 120,000+ Cases",
      description: "Search by meaning, not just keywords. Our AI understands legal context and finds relevant cases from India, US, and Europe instantly.",
    },
    {
      id: "timeline",
      title: "Timeline",
      headline: "Track How Legal Concepts Evolve Over Decades",
      description: "See how concepts like privacy, dowry, or due process changed meaning from 1950 to today with our proprietary Semantic Movement Index.",
    },
    {
      id: "analyze",
      title: "Analyze",
      headline: "AI-Powered Contract Risk Analysis in Seconds",
      description: "Upload any contract and get instant risk scoring, clause detection, and AI-generated suggestions for safer agreements.",
    },
    {
      id: "cases",
      title: "Cases",
      headline: "Browse the Largest Open Indian Case Library",
      description: "Access Supreme Court and High Court judgments from 1950-2026. Filter by court, year, or topic. Full text available.",
    },
    {
      id: "alerts",
      title: "Alerts",
      headline: "Real-Time Drift Alerts for Legal Concepts",
      description: "Set thresholds and get notified when a legal concept undergoes significant semantic change in recent judgments.",
    },
    {
      id: "export",
      title: "Export",
      headline: "Professional PDF Reports & Data Export",
      description: "Generate branded reports of your analysis, export search results, and share insights with your team.",
    }
  ];
      ...
      <section 
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            Track legal evolution. Analyze contracts. Search cases. All powered by 4 AI models trained on legal text.
          </p>
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: "center", marginBottom: 80 }}>
            <h2 style={{ 
              ...
              Complete Legal Intelligence Workflow
            </h2>
          </div>
      ...
      <section 
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            {[
              { stat: "99.9%", description: "AI analysis accuracy across legal research and contracts" },
              { stat: "120K+", description: "cases indexed from Indian, US, and European courts" },
              { stat: "10x", description: "faster than traditional legal research methods" }
            ].map((item, i) => (
              <div 
                key={i}
                style={{
        ...
        <div style={{ 
          ...
          <div style={{
            ...
            {[
              ...
              { company: "JudicialTech", title: "Watch the JudicialTech case study" },
              { company: "LegalAid India", title: "Watch the LegalAid India case study" }
            ].map((item, i) => (
              <div 
                key={i} 
                style={{
      ...
      <section 
        ...
        <div style={{ 
          ...
          <h2 style={{
            ...
            Discover how LawVerse helps 1,000+ legal professionals achieve:
          </h2>
          ...
          <div style={{
            ...
            <div>95% reduction in legal research time</div>
            <div>80% improvement in risk identification</div>
            <div>60% better legal outcomes with AI-powered insights</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ 
                ...
                "LawVerse transformed our legal workflow completely."
              </p>
            </div>
            <div style={{
              background: "#f8f8f8",
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ 
            ...
            <div>
              ...
              <p style={{ 
                ...
                Transform your legal research and contract analysis with cutting-edge AI technology.
              </p>
            </div>
          ...
          <div style={{ 
            ...
            <p style={{ 
              ...
              © 2026 LawVerse. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
