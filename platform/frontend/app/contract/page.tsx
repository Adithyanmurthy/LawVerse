                    ...
                    {contracts.map((c, i) => (
                      <div key={c.id} style={{ padding: "16px 28px", borderBottom: i < contracts.length - 1 ? "1px solid #f4f4f4" : "none", display: "flex", alignItems: "center", gap: 16, transition: "background 0.2s" }}
                        ...
                        <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
                          {c.status === "done" && (
                            <Link href={`/contract/${c.id}`} style={{ fontSize: 12, color: "#1a1a1a", textDecoration: "none", padding: "6px 12px", border: "1px solid #e0e0e0", borderRadius: 4, fontWeight: 500, transition: "all 0.2s" }}
